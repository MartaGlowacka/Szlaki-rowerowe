...
class SingleRandomRoute extends React.Component {
    ...
    render () {
        // console.log(this.randomRoute())
        console.log(this.state.random)
        console.log(this.state.id[this.state.random])
        ...
        return(
            <div style={style}>
            {/* <img src="../images/Kaczka_01.png" /> */}
                <div style={{order: '2', backgroundColor: 'pink', width: '60%'}}><img style={{height: '200px', width: '350px'}}  src={`/src/images/${this.state.image}`} /></div>
